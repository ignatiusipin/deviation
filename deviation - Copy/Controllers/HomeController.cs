...
namespace deviation.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            string fullpath = @"\\KALBOX-B7.BINTANG7.com\Intranetportal\Intranet Attachment\Deviation\";
            string filename = "IT - PDCA - 20190422.xlsx";
           // fullpath = Server.MapPath(fullpath) + filename;
            return File(fullpath, System.Net.Mime.MediaTypeNames.Application.Octet, Path.GetFileName(fullpath+filename));
        }
